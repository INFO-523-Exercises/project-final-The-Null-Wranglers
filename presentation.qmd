...
## Tables
## Plot 1
![](images/TSA1.png){width=100%}
## Plot 2
![](images/TSA2.png){width=100%}
## Plot 3
![](images/TSA3.png){width=100%}
# Decision Tree
## Code
``` r
...
# Math Expressions
{.smaller} You can write LaTeX math expressions inside a pair of dollar signs, e.g. \$\\alpha+\\beta\$ renders $\alpha + \beta$. You can use the display style with double dollar signs:
```
