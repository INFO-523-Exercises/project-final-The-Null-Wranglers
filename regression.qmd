...
```{r}
session_regression_data_table<- session_regression_data %>% plot_correlate()
ggsave("images/msession_regression_data-table.png", plot = session_regression_data_table)
```
