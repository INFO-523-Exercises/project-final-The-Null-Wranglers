...
(1) DEW Rates -- Breakdown of grade value outcomes during the academic years of 2018-19, 2019-20, and 2020-21 at UArizona.

(2) Course Attributes -- Course attributes for the academic years of 2019-20, and 2020-21 at UArizona.
...
*We also looked at the total D, F, and W grade counts for each college per semester.*
...
*We also calculated average number of D, F, W per course by college each semester.*
...
![Total DEW Count for different colleges changed over different Terms](images/TSA1.png){width="100%"}

## Plot 2

![Total D, E (fail) and W (withdraw) count for different colleges changed over different Terms](images/TSA2.png){width="100%"}

## Plot 3

![Count of Course Levels for different colleges changed over different Terms](images/TSA3.png){width="100%"}

## Plot 4

![Total Classes Attended in Different Time Slots for Colleges changed over different Terms](images/TSA4.png){width="100%"}
...
Correlation of DEW Count, Total Enroll, Rm cap

![](images/general_regression_data_table.png){width="647"}

## Correlate - Day of Classes

![](images/day_regression_data_table.png){width="631"}
