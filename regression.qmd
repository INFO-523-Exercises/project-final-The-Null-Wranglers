...
htmlwidgets::saveWidget(correlate_table, file = "images/correlate_table.html")

# Capture the HTML file as an image using webshot
webshot::webshot("images/correlate_table.html", file = "images/correlate_table.png")
...
lambda_values <- 10^seq(10, -2, length = 100)
# Train Lasso regression model with cross-validation
lasso_model <- cv.glmnet(X, y, alpha = 0, lambda = lambda_values)
# Plot training and testing errors
plot(ridge_model$glmnet.fit, xvar = "lambda", label = TRUE, lwd = 2, col = c("blue", "red"), main = "Lasso Regression - Training and Testing Errors")
legend("topright", legend = c("Training", "Testing"), col = c("blue", "red"), lty = 1)
```
